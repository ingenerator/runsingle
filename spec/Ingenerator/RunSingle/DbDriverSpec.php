...
class DbDriverSpec extends ObjectBehavior
{
    ...
    {
        $db_object->execute(self::INSERT_LOCK_SQL, array(':task_name' => self::TASK_NAME, ':timeout' =>self::TIMEOUT, ':timestamp' => self::FAKE_TIMESTAMP))->willReturn();
        $db_object->get_db_table_name()->willReturn('locks');
        $db_object->fetch_all(self::SELECT_LOCK_SQL, array(':task_name' => self::TASK_NAME, ':current_timestamp' => self::FAKE_TIMESTAMP))->willReturn();
    ...
    function its_get_lock_inserts_a_lock_if_none_already($db_object)
    {
        ...
        $db_object->execute(self::INSERT_LOCK_SQL, array(':task_name' => self::TASK_NAME, ':timeout' =>self::TIMEOUT, ':timestamp' => self::FAKE_TIMESTAMP))
    ...
    function its_garbage_collect_does_not_delete_if_no_expired_locks($db_object)
    {
        ...
        $db_object->execute(self::DELETE_LOCK_SQL, array(':task_name' => self::TASK_NAME, ':lock_timestamp' => self::FAKE_TIMESTAMP))
    ...
    {
        $db_object->fetch_all(self::SELECT_LOCK_SQL, array(':task_name' => self::TASK_NAME, ':current_timestamp' => self::FAKE_TIMESTAMP))
            ->shouldHaveBeenCalled();
    }
    ...
    {
        $db_object->execute(self::DELETE_LOCK_SQL, array(':task_name' => $task_name, ':lock_timestamp' => $lock_timestamp))
            ->shouldHaveBeenCalled();
    }
